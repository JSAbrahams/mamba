...
# 1.3 Imperative Versus Functional, or, Idealism versus Pragmatism

There are multiple programming paradigms in computer science.
A few of the popular ones are outlined in this short, non-exhaustive list:
...
Each comes with their own (or overlapping) set of philosophies and schools of thought.
