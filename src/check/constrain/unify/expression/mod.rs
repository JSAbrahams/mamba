use crate::check::constrain::constraint::expected::Expect::{Expression, ExpressionAny, Collection, Tuple};
...
pub fn unify_expression(
    ...
    match (&left.expect, &right.expect) {
        ...
        //             for e in elements {
        //                 constraints.push("expression and collection", &Expected::try_from((e, &Environment::default()))?, ty);
        //                 pushed += 1;
        //             },
        //         _ => {}
        //     }
        ...
        //                             tuple_exp,
        //                             &Expected::try_from((expr_ast, &Environment::default()))?
        //                         );
        //                         pushed += 1;
        //                     }
        //                     _ => {
        ...
        //                     let l_exp = Expected::try_from((l, &Environment::default()))?;
        //                     let r_exp = Expected::try_from((r, &Environment::default()))?;
