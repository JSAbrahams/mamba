...
#[test_case("collection", "list_assign_fin" => matches Err(_))]
...
#[test_case("function", "call_mut_function_on_non_mut" => ignore["checker shouldn't allow mutable methods on fin"])]
